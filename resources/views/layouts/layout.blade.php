...
<head>
  ...
  <!-- <link rel="stylesheet" href="{{ asset('assets/vendor/source_code_pro/SourceCodePro-Black.ttf') }}"> -->


  <link rel="stylesheet" href="{{ asset('assets/vendor/buttons/buttons.dataTables.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/vendor/buttons/buttons.print.min.js') }}">
  <link rel="stylesheet" href="{{ asset('assets/vendor/buttons/buttons.html5.min.js') }}">
  <link rel="stylesheet" href="{{ asset('assets/vendor/buttons/dataTables.buttons.min.js') }}">
  ...
  <div class="wrapper ">
    ...
    @if(!auth()->user()->hasRole('Admin'))
      <a href="/dashboard" class="brand-link">
        <img src="{{ asset('images/its.png') }}" alt="ITS Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<!-- JQuery -->
 ...
 <script src="{{ asset('assets/vendor/html2pdf/html2pdf.bundle.js') }}"></script>
 <script src="{{ asset('assets/vendor/jspdf/jspdf.umd.min.js') }}"></script>

  <!-- Include Bootstrap 4 -->
  <script src="{{ asset('theme/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

  <link href="{{ asset('assets/vendor/jquery-ui/themes/base/jquery-ui.css') }}" rel="stylesheet">
