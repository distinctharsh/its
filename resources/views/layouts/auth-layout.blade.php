...
<head>
  ...
  <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
  ...
  <link rel="stylesheet" href="{{ url('assets/vendor/bootstrap/bootstrap-icons.min.css') }}">
...
<body class="d-flex justify-content-center align-items-center" style="background: url({{ url('images/login-background.jpg') }}) no-repeat center center fixed; background-size: cover; height: 100vh;">
  @yield('content')
