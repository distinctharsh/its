<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
    ...
    @php
    $isActiveRoute = request()->routeIs('manageNationality', 'manageState', 'manageRank', 'manageDesignation', 'manageStatus', 'manageInspectionCategory', 'manageCategoryInspection', 'manageInspectionCategoryType', 'manageVisitCategory', 'manageEscortOfficer', 'manageSiteCode');
    @endphp
    <li class="nav-item {{ $isActiveRoute ? 'menu-open' : '' }}">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="{{ route('manageUser') }}" data-toggle="tooltip" data-placement="top" title="User Master" class="nav-link {{ request()->routeis('manageUser') ? 'active' : '' }}">
