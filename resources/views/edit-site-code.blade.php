            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group status-form-group">
                        ...
                        <input type="text" class="form-control" id="edit_site_code" name="site_code" value="{{ $siteCode->site_code }}" placeholder="Enter Site Code" required>
                    </div>
        ...
        $('#updateSiteCodeForm').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        FancyAlerts.show({
                            msg: response.msg || 'Site Code updated successfully!',
                            type: 'success'
                        });
                        setTimeout(function() {
                            location.reload();
