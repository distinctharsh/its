...
<div class="container-fluid mt-4">
    <!-- <h3 class="mb-4">Add New Status</h3> -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 form-group status-form-group">
                        ...
                        <input class="form-control" id="status_name" name="status_name" required></input>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#addStatusForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('createStatus') }}",  // Change the route to the appropriate one for reports
                type: "POST",
                headers: {
                ...
                success: function(response) {
                    if (response.success) {
                        FancyAlerts.show({
                            msg: response.msg || 'Status added successfully!',
                            type: 'success'
                        });
                        setTimeout(function() {
                            location.reload();
