    ...
    <table class="table table-bordered table-striped" id="myTable">
        ...
        <tbody id="inspectorTableBody">
            ...
            <tr data-status="{{ is_null($inspector->deleted_at) ? 'active' : 'inactive' }}" data-join-date="{{ $inspector->inspections->isNotEmpty() ? $inspector->inspections->first()->date_of_joining : '' }}">
                ...
                <a href="{{ asset('storage/app/' . $inspector->ib_clearance) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="IB Clearance">
                    <i class="fa-solid fa-file-pdf"></i>
                </a>
                @endif
                @if($inspector->raw_clearance)
                <a href="{{ asset('storage/app/' . $inspector->raw_clearance) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="RAW Clearance">
                    <i class="fa-solid fa-file-pdf"></i>
                </a>
                @endif
                @if($inspector->mea_clearance)
                <a href="{{ asset('storage/app/' . $inspector->mea_clearance) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="MEA Clearance">
                    <i class="fa-solid fa-file-pdf"></i>
                </a>
                @endif
            </td>
