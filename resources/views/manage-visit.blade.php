    ...
    data-join-date="{{ $visit->arrival_datetime ? $visit->arrival_datetime->format('Y-m-d') : '' }}">
                ...
                <td class="text-center">
                    ...
                    <div class="pdf-icons-container mt-2">
                        ...
                        <a href="{{ asset('storage/app/' . $visit->clearance_certificate) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="Preliminary Report">
                        ...
                        <a href="{{ asset('storage/app/' . $visit->visit_report) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="Final Inspection Report">
                            <i class="fa-solid fa-file-pdf"></i>
                        </a>
                        @else
                ...
                <td class="text-center">
                    ...
                    <td class="text-center">{{ $visit->inspection_issue_id ? $visit->inspectionIssue->name : '' }}
                        ...
                        <br>
                        <a href="{{ asset('storage/app/' . $visit->issue_document) }}" target="_blank" class="pdf-icon" data-toggle="tooltip" title="Document"><i class="fa-solid fa-file-pdf"></i></a>
                        @endif
                    </td>
        ...
        $(document).on('change', '.switch input', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/inspection/' + visitId + '/update-status',
                        type: 'PATCH',
                        headers: {
