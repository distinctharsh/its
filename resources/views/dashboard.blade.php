...
<script src="{{ url('assets/vendor/datatables/chartjs-plugin-datalabels.js') }}?v={{ filemtime(public_path('assets/vendor/datatables/chartjs-plugin-datalabels.js')) }}"></script>
