                ...
                <!-- <div class="row">
                    <div class="col-md-6 form-group inspection-form-group">
                        ...
                        <div style="position: relative;">
                            <img id="addDesignationCaptchaImage" src="{{ route('captcha') }}" alt="captcha" class="captcha-image">
                            <i class="fa-solid fa-arrows-rotate" style="position: absolute; top: 10px; right: 10px; cursor: pointer;" onclick="refreshCaptcha('addDesignationCaptchaImage')"></i>
                        </div>
