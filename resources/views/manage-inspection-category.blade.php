...
<div class="container-fluid mt-4">
    ...
    <table class="table table-bordered table-striped" id="myTable" data-export-columns="0,1, 2, 3">
        ...
        $(document).on('change', '.switch input', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: base_url+'/inspection-category/' + inspectionCategoryId + '/update-status',
                        type: 'PATCH',
                        headers: {
