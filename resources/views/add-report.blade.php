...
<div class="container-fluid mt-4">
    <h3 class="mb-4">Add New Report</h3>
    ...
    <form id="addReportForm" enctype="multipart/form-data">
        ...
        <div class="card card-outline-secondary report-form">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 form-group report-form-group">
                        <label for="captcha">Enter Captcha</label>
                        <div style="position: relative;">
                            <img id="addReportCaptchaImage" src="{{ route('captcha') }}" alt="captcha" class="captcha-image">
                            <i class="fa-solid fa-arrows-rotate" style="position: absolute; top: 10px; right: 10px; cursor: pointer;" onclick="refreshCaptcha('addReportCaptchaImage')"></i>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#addReportForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('createReport') }}",  // Change the route to the appropriate one for reports
                type: "POST",
                headers: {
                ...
                success: function(response) {
                    if (response.success) {
                        FancyAlerts.show({
                            msg: response.msg || 'Report added successfully!',
                            type: 'success'
                        });
                        setTimeout(function() {
                            location.reload();
