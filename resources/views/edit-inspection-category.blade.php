            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group inspection-category-form-group">
                        ...
                        <input type="text" class="form-control" id="edit_category_name" name="category_name" value="{{ $inspection_category->category_name }}" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group inspection-category-form-group">
                        ...
                        <select id="inspection_types" name="inspection_types[]" class="form-control" multiple required>
                            ...
                            <option value="{{ $type->id }}" {{ $inspection_category->types->contains($type->id) ? 'selected' : '' }}>
                                {{ $type->type_name }}
                            </option>
                            @endforeach
                        </select>
...
<script>
    $(document).ready(function() {
        ...
        $('#updateInspectionCategoryForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('updateInspectionCategory', '') }}/" + inspectionCategoryId,
                type: 'POST',
                headers: {
