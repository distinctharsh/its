        ...
        <div class="card card-outline-secondary inspector-form">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group inspector-form-group">
                        ...
                        <span id="current-file" class="d-block">Current Document: <a href="{{ url('storage/app/' . $inspector->ib_clearance) }}" target="_blank">View Document</a></span>
                        @else
                    ...
                    <div class="col-md-4 form-group inspector-form-group">
                        ...
                        <span id="current-file" class="d-block">Current Document: <a href="{{ url('storage/app/' . $inspector->raw_clearance) }}" target="_blank">View Document</a></span>
                        @else
                        <span id="current-file" class="d-block">No Document Available</span>
                        @endif
                    ...
                    <div class="col-md-4 form-group inspector-form-group">
                        ...
                        <span id="current-file" class="d-block">Current Document: <a href="{{ url('storage/app/' . $inspector->mea_clearance) }}" target="_blank">View Document</a></span>
                        @else
                        <span id="current-file" class="d-block">No Document Available</span>
                        @endif
                    ...
                    <div class="col-md-12 form-group inspector-form-group border rounded p-3 bg-light">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 mt-4 form-group inspector-form-group" id="routine_objection_file_section" style="display:none;">
                                ...
                                <span id="current-file" class="d-block">Current Objection Document: <a href="{{ url('storage/app/' . $routineInspection->routine_objection_document) }}" target="_blank">View Document</a></span>
                                @else
                    ...
                    <div class="col-md-12 form-group inspector-form-group border rounded p-3 bg-light mt-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 mt-4 form-group inspector-form-group" id="challenge_objection_file_section" style="display:none;">
                                ...
                                <span id="current-file" class="d-block">Current Objection Document: <a href="{{ url('storage/app/' . $challengeInspection->challenge_objection_document) }}" target="_blank">View Document</a></span>
                                @else
                                <span id="current-file" class="d-block">No Objection Document Available</span>
                                @endif
            ...
            <div class="card-footer text-center">
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    <span id="submitText">Update Inspector</span>
            ...
            if (validateForm()) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        submitText.text('Update Inspector');
