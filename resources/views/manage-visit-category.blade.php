...
<div class="container-fluid mt-4">
    ...
    <div class="row">
    <div class="col-12">
    <a href="{{ route('addVisitCategory') }}" class="btn btn-primary mb-3 float-left" data-toggle="tooltip" data-placement="left" title="Add"><i class="fa-solid fa-plus"></i></a>
        ...
        $(document).on('change', '.switch input', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: base_url+'/visit-category/' + visitCategoryId + '/update-status',
                        type: 'PATCH',
                        headers: {
