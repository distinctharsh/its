...
<div class="container-fluid mt-4">
    <!-- <h3 class="mb-4">Add New Nationality</h3> -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 form-group nationality-form-group">
                        <label for="country_name">Nationality Name</label>
                ...
                <!-- <div class="row">
                    <div class="col-md-3 form-group inspection-form-group">
                        <img id="addNationalityCaptchaImage" src="{{ route('captcha') }}" alt="captcha" class="captcha-image mr-2">
                        <i class="fa-solid fa-arrows-rotate" style="cursor: pointer;" onclick="refreshCaptcha('addNationalityCaptchaImage')"></i>
...
<script>
    $(document).ready(function() {
        ...
        $('#addNationalityForm').submit(function(e) {
            e.preventDefault();

            var formData = new FormData(this);

            $.ajax({
                url: "{{ route('createNationality') }}",
                type: "POST",
                headers: {
                ...
                success: function(response) {
                    if (response.success) {
                        FancyAlerts.show({
                            msg: response.msg || 'Nationality added successfully!',
                            type: 'success'
                        });
                        setTimeout(function() {
                            location.reload();
