            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group inspector-form-group">
                        ...
                        <textarea class="form-control" id="acentric_report" name="acentric_report" rows="3" required> {{ $visit->acentric_report }}</textarea>
                    </div>
                </div>
            ...
            if (selectedCategoryTypeId == '2') {
                ...
                visitSiteMapping.forEach(function(mapping, index) {
                    if (index < iterationCount) {
                        ...
                        let preliminaryReportPath = "{{ url('storage/app/') }}" + "/" + mapping.preliminary_report;
                        ...
                        let finalInspectionReportPath = "{{ url('storage/app/') }}" + "/" + mapping.final_inspection_report;
                        ...
                        let issueDocumentPath = "{{ url('storage/app/') }}" + "/" + mapping.issue_document;
                ...
                for (let i = 0; i < iterationCount; i++) {
                    $('#inspectionFields').append(`
                        ${generateInspectionCategorySelect([2, 3, 4])}
                        ${generateInspectionPhaseSelect()}
                        ${generateSiteCodeSelect()}
