            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control datepicker" id="opcw_communication_date" name="opcw_communication_date" placeholder="dd/ mm/ yyyy"
                            value="{{ isset($staff) ? \Carbon\Carbon::parse($staff->opcw_communication_date)->format('Y-m-d') : '' }}">
                    </div>
        
                    <div class="col-4">
                        <label for="opcw_communication_date">Deletion Date</label>
                        <input type="text" class="form-control datepicker" id="opcw_communication_date" name="opcw_communication_date" placeholder="dd/mm/yyyy"
